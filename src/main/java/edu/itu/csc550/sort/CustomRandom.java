...
class CustomRandom {
  ...
  private static class RandomConstant {
    final CustomUnsigned a;
    final CustomUnsigned c;
    public RandomConstant(String left, String right) {
      a = new CustomUnsigned(left);
      c = new CustomUnsigned(right);
    }
  }
   ...
   *  generator.
   */
  public static CustomUnsigned skipAhead(CustomUnsigned advance) {
   ...
   */
  public static void nextRand(CustomUnsigned rand) {
