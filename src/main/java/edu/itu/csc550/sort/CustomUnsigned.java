 ...
 * and left shifts.
 */
class CustomUnsigned implements Writable {
  private long hi8;
  private long lo8;

  public CustomUnsigned() {
    hi8 = 0;
    lo8 = 0;
  }

  public CustomUnsigned(long l) {
    hi8 = 0;
    lo8 = l;
  }

  public CustomUnsigned(CustomUnsigned other) {
    hi8 = other.hi8;
    lo8 = other.lo8;
  }
  ...
  public boolean equals(Object o) {
    if (o instanceof CustomUnsigned) {
      CustomUnsigned other = (CustomUnsigned) o;
   ...
   */
  public CustomUnsigned(String s) throws NumberFormatException {
    set(s);
  }
  ...
  private static final CustomUnsigned TEN = new CustomUnsigned(10);

  public static CustomUnsigned fromDecimal(String s) throws NumberFormatException {
    CustomUnsigned result = new CustomUnsigned();
   ...
   */
  void multiply(CustomUnsigned b) {
   ...
   * @param b the other number
   */
  public void add(CustomUnsigned b) {
    long sumHi;
    long sumLo;
