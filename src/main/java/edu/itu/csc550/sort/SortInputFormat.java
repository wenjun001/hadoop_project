 ...
 * as Text.
 */
public class SortInputFormat extends FileInputFormat<Text,Text> {

  static final String PARTITION_FILENAME = "_partition.lst";
  private static final String NUM_PARTITIONS = 
    "mapreduce.sort.num.partitions";
  private static final String SAMPLE_SIZE = 
    "mapreduce.sort.partitions.sample";
  ...
  public List<InputSplit> getSplits(JobContext job) throws IOException {
    ...
    if (job.getConfiguration().getBoolean(SortScheduler.USE, true)) {
      ...
      System.out.println("Spent " + (t3 - t2) + "ms computing SortScheduler splits.");
    }
    return lastResult;
  }
}
