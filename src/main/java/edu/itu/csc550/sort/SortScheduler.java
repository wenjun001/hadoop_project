...
class SortScheduler {
  static String USE = "mapreduce.sort.use.terascheduler";
  private static final Log LOG = LogFactory.getLog(SortScheduler.class);
  ...
  public SortScheduler(String splitFilename,
  ...
  public SortScheduler(FileSplit[] realSplits,
  ...
  public static void main(String[] args) throws IOException {
    SortScheduler problem = new SortScheduler("block-loc.txt", "nodes");
