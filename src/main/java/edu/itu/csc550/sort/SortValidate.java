...
public class SortValidate extends Configured implements Tool {
  ...
  static class ValidateMapper extends Mapper<Text,Text,Text,Text> {
    ...
    private CustomUnsigned tmp = new CustomUnsigned();
  ...
  public int run(String[] args) throws Exception {
    ...
    job.setJobName("SortValidate");
    job.setJarByClass(SortValidate.class);
  ...
  public static void main(String[] args) throws Exception {
    int res = ToolRunner.run(new Configuration(), new SortValidate(), args);
    System.exit(res);
  }
