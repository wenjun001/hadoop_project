...
public class MySort extends Configured implements Tool {
  ...
  static String SIMPLE_PARTITIONER = "mapreduce.sort.simplepartitioner";
  static String OUTPUT_REPLICATION = "mapreduce.sort.output.replication";
  ...
  static class TotalOrderPartitioner extends Partitioner<Text,Text>
    ...
    public void setConf(Configuration conf) {
      try {
        ...
        this.conf = conf;
        Path partFile = new Path(SortInputFormat.PARTITION_FILENAME);
